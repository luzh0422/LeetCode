...
/**
 * 利用类型 + 图的概念，分别实现不同类型的广度优先遍历；
 * @param n
 * @param redEdges
 * @param blueEdges
 * @return
 */
vector<int> LeetCode1129::shortestAlternatingPaths(int n, vector<vector<int>> &redEdges, vector<vector<int>> &blueEdges) {
